...
namespace Sales_Managment
{
    public partial class Frm_DeservedReport : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            tbl.Clear();
            tbl = db.readData("select Deserved.Des_Id as 'رقم العملية', price as 'المبلغ المدفوع', Date as 'تاريخ العملية' , Notes as 'ملاحظات', Deserved_Type.Des_Name as 'النوع' from Deserved, Deserved_Type where Deserved_Type.Des_Id = Deserved.Des_Id and CONVERT(date, Date, 105) between '" + date1 + "' and '" + date2 + "'", "");
